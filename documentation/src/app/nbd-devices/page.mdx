...
TRIM deletes extent pointers for fully covered extents and debits the affected segments' live-byte counters. Segment reclamation later deletes empty segments or repacks fragmented ones; object-store usage does not necessarily decrease immediately. See [Space Reclamation](/space-reclamation).
