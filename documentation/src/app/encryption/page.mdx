  ...
  <Col>
    ...
    <Properties>
      ...
      <Property name="Segment Directory" type="encrypted">
        Each segment ends with a reverse-map directory (inode and extent index per frame, used by reclamation). It is sealed as one AEAD frame, so the file-to-frame mapping is not readable from the object store.
      </Property>
